...
execute store result score $tls_nb__item__start tms.var run clear @s compass[custom_data={start: 1b, config: 1b}] 0
execute unless data storage config:inventory {start: 1b} run item replace entity @s[tag=tls_stg__start] hotbar.0 with wooden_axe[custom_data={start: 1b, config: 1b}] 1
execute if score $tls_nb__item__start tms.var matches 2.. run clear @s wooden_axe[custom_data={start: 1b, config: 1b}]

# Checkpoint
execute store result storage config:inventory checkpoint byte 1 run data get entity @s Inventory[].components.minecraft:custom_data.chec 1
execute store result score $tls_nb__item__chec tms.var run clear @s compass[custom_data={checkpoint: 1b, config: 1b}] 0
execute unless data storage config:inventory {checkpoint: 1b} run item replace entity @s[tag=tls_stg__chec] hotbar.0 with wooden_axe[custom_data={checkpoint: 1b, config: 1b}] 1
execute if score $tls_nb__item__chec tms.var matches 2.. run clear @s wooden_axe[custom_data={checkpoint: 1b, config: 1b}]

item modify entity @s[tag=tls_stg__config] hotbar.0 config:config
