...
execute unless score $tls_mode tms.var matches 1.. run function config:hud/chat/properties/mode
execute if score $tls_mode tms.var matches 1 run function config:hud/chat/properties/mode/kart
execute if score $tls_mode tms.var matches 2 run function config:hud/chat/properties/mode/boat
execute if score $tls_mode tms.var matches 3 run function config:hud/chat/properties/mode/runner
...
tellraw @s [{text: "Player", color: "gray"}, {text: ": ", color: "yellow"}, {storage: "config:settings", nbt: "ghost.properties.player", color: "dark_gray"}]
