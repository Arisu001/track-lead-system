execute store result score $tls_count__player__race tms.var if entity @a[tag=tls_racer]

execute unless score $tls_count__player__race tms.var matches 2.. run function tls:config/racer/reset
